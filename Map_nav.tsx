...
const MapView: React.FC = () => {
  ...
  const socketPosition = useRef(io('http://192.168.137.120:5005', { transports: ['websocket'] })).current;
  // Socket to send goal to Flask server (port 5008)
  const socketGoal = useRef(io('http://192.168.137.120:5008', { transports: ['websocket'] })).current;
